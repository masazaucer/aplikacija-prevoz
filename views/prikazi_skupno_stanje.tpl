% rebase('analiza.tpl', izbrani_zavihek='analiza_skupno')
...
<body>
<div class="container">
  <h2>Prikaz skupne porabe za vsa sredstva</h2>
  <ul class="collapsible">
    <li>
        <div class="collapsible-header"><i class="material-icons">ev_station</i>Poraba CO2</div>
        <div class="collapsible-body"><span>S svojimi potmi si proizvedel {{round(stanje.skupni_izpusti())}} gramov CO2.</span></div>
    </li>
    <li>
        <div class="collapsible-header"><i class="material-icons">euro_symbol</i>Cena</div>
        <div class="collapsible-body"><span>Za vse svoje poti si porabil {{round(stanje.skupna_cena(), 2)}} €.</span></div>
    </li>
    <li>
        <div class="collapsible-header"><i class="material-icons">access_time</i>Čas</div>
        <div class="collapsible-body"><span>Za vse svoje poti si porabil {{round(stanje.skupno_trajanje() / 3600, 2)}} ur.</span></div>
    </li>
        <li>
        <div class="collapsible-header"><i class="material-icons">map</i>Skupna razdalja</div>
        <div class="collapsible-body"><span>Z vsemi svojimi potmi si opravil {{round(stanje.skupna_razdalja() / 1000, 2)}} kilometrov.</span></div>
    </li>
  </ul>
</div>
...
<div class="container">
  <div class="carousel carousel-slider center">
      <div class="carousel-item green li  hten-2 white-text" href="#one!">
        <h2><i class="material-icons">ev_station</i>Izpusti CO2</h2>
        <p class="white-text">Analiza izpustov CO2 za vse poti.</p>
        <table class="colum">
          <tr>
      ...
      <div class="carousel-item pink lighten-2 white-text" href="#two!">
        ...
        <p class="white-text">Analiza stroškov vseh poti.</p>
        <table class="colum">
          <tr>
      ...
      <div class="carousel-item teal lighten-2 white-text" href="#three!">
        ...
        <p class="white-text">Analiza trajanja vseh poti.</p>
        <table class="colum">
          <tr>
      ...
      <div class="carousel-item purple lighten-2 white-text" href="#three!">
        ...
        <p class="white-text">Analiza dolžine vseh poti.</p>
        <table class="colum">
          <tr>
