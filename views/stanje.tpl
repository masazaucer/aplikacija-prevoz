    ...
    <div class="row">
      ...
      <div class="col s12 m4">
        <div class="icon-block">
          ...
          <h5 class="center">Kako pomemben vam je vaš čas?</h5>
      ...
      <div class="col s12 m4">
        <div class="icon-block">
          ...
          <h5 class="center">Kako pomembno vam je varovanje okolja?</h5>
            ...
            <div class="input-field col s12 m12">
              <form action="/pomembnost-onesnazevanja/" method="POST">
                <select class="icons" name="pomembnost_onesnazevanja">
                  ...
                  <option value="zelo" selected>Zelo pomembno</option>
                  <option value="srednje" >Srednje pomembno</option>
                  <option value="malo" >Manj pomembno</option>
                  % elif uporabnik.pomembnost_onesnazevanja == False:
                  <option value="" disabled>Pomembnost okolja</option>
                  <option value="zelo" >Zelo pomembno</option>
                  <option value="srednje" >Srednje pomembno</option>
                  <option value="malo" selected>Manj pomembno</option>
                  % elif uporabnik.pomembnost_onesnazevanja == None:
                  <option value="" disabled>Pomembnost okolja</option>
                  <option value="zelo" >Zelo pomembno</option>
                  <option value="srednje" selected>Srednje pomembno</option>
                  <option value="malo" >Manj pomembno</option>
                  %end
                </select>
...
<div class='center'>
  <h5>
    Vsako svojo izbiro moraš potrditi!
  </h5>
</div>
